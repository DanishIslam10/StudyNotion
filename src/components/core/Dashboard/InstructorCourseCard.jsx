...
const InstructorCourseCard = ({ thumbnail, name, description, price, createdAt, hasPublished }) => {
    return (
        <div className="flex sm:flex-row flex-col justify-center items-center gap-4 text-[white] md:mb-12 mt-4 md:mx-4">
            <img className="aspect-square w-44 max-h-60 object-cover rounded-md " src={thumbnail} />
            <div className="w-full flex flex-col gap-4 justify-evenly px-5">
                <div className="md:w-[80%] flex flex-col gap-2" >
                    <p className="text-xl font-[600] text-[#F1F2FF] ">{name}</p>
                    <p className="text-sm font-[400] text-[#AFB2BF] ">{description}</p>
                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-4 text-[#7e7e7e] text-lg ">
                        ...
                        <button className="flex items-center bg-[#691432] p-2 rounded-full text-[#EF476F] 
